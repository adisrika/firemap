        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full border border-gray-200 rounded-lg pl-8 pr-4 py-2.5 text-navy-800 focus:outline-none focus:ring-2 focus:ring-fire-500 focus:border-transparent transition"
              min={500}
              max={50000}
              step={100}
            />
          ...
          <>
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-navy-800 focus:outline-none focus:ring-2 focus:ring-fire-500 focus:border-transparent transition"
                min={18}
                max={79}
              />
            </div>
